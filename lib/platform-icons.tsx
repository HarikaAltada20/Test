...
export const getPlatformIcon = (
  ...
  if (lowerPlatform?.includes("tiktok"))
    return (
      <div className={`flex items-center justify-center ${sizeClasses[size]}`}>
        <svg viewBox="0 0 24 24" className={sizeClasses[size]} fill="#000000">
  ...
  if (lowerPlatform?.includes("twitter") || lowerPlatform?.includes("x.com"))
    return (
      <div className={`flex items-center justify-center ${sizeClasses[size]}`}>
        <svg viewBox="0 0 24 24" className={sizeClasses[size]} fill="#1DA1F2">
  ...
  if (lowerPlatform?.includes("linkedin"))
    return (
      <div className={`flex items-center justify-center ${sizeClasses[size]}`}>
        <svg viewBox="0 0 24 24" className={sizeClasses[size]} fill="#0077B5">
