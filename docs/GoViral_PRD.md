...
#### **3. Value Proposition for Each Plan**
- **Higher tier plans** get lower commission rates
- **More simultaneous contests** for scaling brands
- **Lower minimum budgets** for premium users
- **More winners allowed** for larger campaigns
...
#### **Post-Contest Status Management**
Based on the memory about post-contest status management:
- Only admins can change contest status to 'payouts_processed' since the platform is responsible for payout processing
- Brands can handle verification and change status to 'verification_complete'
- Payment processing is restricted to admin-only operations
- The API enforces this with a 403 error, and the frontend hides the payouts_processed option from brand users
...
## FAQ - Common Questions About GoViral

Based on the platform's FAQ documentation, here are key questions and answers:
...
### **2. How can GoViral help me find content-market fit?**
GoViral helps you test different content styles, creator personalities, and messaging angles at scale with real audiences. By running contests with multiple submissions, you'll quickly discover what resonates with your target market.

### **3. How do I know the views are real?**
All content is posted on creators' real social media accounts with public links. You can verify views yourself and see platform-specific analytics. We only count native platform views—no bots, no boosts, just genuine engagement.

### **4. How are creators paid?**
Creators are only paid if they win the contest, based on the prize structure you set up. GoViral handles secure payouts to creators after contest completion.

### **5. How many creators are on GoViral?**
We have a fast-growing network of 5,000+ active creators across various niches. When you launch a contest, it goes live to all eligible creators through our dashboard and email system.

### **6. How much should I run a contest for?**
- $1,000–$2,000 for a range of quality UGC entries
- $500+ for niche campaigns or specific messaging
- Higher payouts attract creators with larger audiences
