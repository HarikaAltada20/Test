                ...
                >
                  ...
                  <CardHeader>
                    <div className="flex justify-center mb-4">
                      <div
                        className={`w-14 h-14 rounded-full flex items-center justify-center ${getPlanBgColor(
                          plan.name
                        )}`}
                      >
                    ...
                    <CardDescription className="text-center mt-2 h-10">
                      {" "}
                      {/* Added fixed height */}
                  ...
                  <CardFooter className="pt-6">
                    <Button
                      className={`w-full ${
                        isMostPopular ? "bg-rose-600 hover:bg-rose-700" : ""
                      }`}
                      asChild
                    >
