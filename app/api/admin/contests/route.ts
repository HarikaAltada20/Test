...
export async function POST(request: NextRequest) {
  try {
    ...
    const insertData = {
      ...
      min_avg_quality_score: draftFields.min_avg_quality_score ?? null,
      min_best_quality_score: draftFields.min_best_quality_score ?? null,
      min_platform_earnings: draftFields.min_platform_earnings ?? null,
      min_platform_views: draftFields.min_platform_views ?? null,
