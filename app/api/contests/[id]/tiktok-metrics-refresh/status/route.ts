/**
 * GET: Return latest TikTok metrics refresh run for the contest (for admin polling).
 */
...
export async function GET(
  ...
  try {
    ...
    if (error) {
      console.error("[tiktok-metrics-refresh status]", error);
    ...
    console.error("[tiktok-metrics-refresh status]", e);
    return NextResponse.json(
