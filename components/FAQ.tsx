...
const homeFaqs = [
  {
    ...
    answer: `<strong>Game of Creators democratizes brand deals</strong> by allowing any creator—even those with zero followers—to participate in campaigns and earn money based purely on <strong>performance and views</strong>.<br><br><strong>For brands,</strong> this system is a game-changer: a single campaign can inspire <strong>hundreds to thousands of creators</strong> to generate viral marketing content for your product. You get <strong>widespread promotion</strong> and a <strong>huge variety of content</strong>, yet you only reward the <strong>best-performing creators</strong>, ensuring you pay just for the most impactful results.`,
  },
  {
    id: "faq-home-2",
  ...
  {
    id: "faq-home-6",
    question: "How long does the event or campaign last?",
    answer:
      "Campaigns typically last between 3 to 28 days, depending on the brand's selection.",
  },
  {
    id: "faq-home-7",
  ...
  },
  {
    ...
    answer: `<strong>Brands provide a complete campaign brief</strong> including:<br>• Required resources<br>• Inspirational links<br>• Detailed guidance<br><br><strong>Need help?</strong> You can always reach out for assistance or clarification!`,
  },
  {
    id: "faq-home-9",
    question: "What happens if a participant misses a deadline?",
    answer:
      "Content must be submitted during the live campaign period. Submissions must be posted on YouTube or Instagram and linked to the campaign within two hours of posting. Late submissions won't be accepted.",
  },
  {
    id: "faq-home-10",
    question: "How are participants judged or evaluated?",
    answer:
      "Judging is based purely on views. Participants must follow the campaign's brief, rules, and guidelines to be eligible for payment.",
  },
  {
    id: "faq-home-11",
    question: "How can participants track their progress?",
    answer:
      "Creators can track all their submissions in My submissions section and see their ranking of each campaign they participated by visiting that campaign leaderboard section.",
  },
  {
    id: "faq-home-12",
    question: "Can participants submit multiple entries?",
    answer: "No, participants can only submit one entry per campaign.",
  },
  {
    id: "faq-home-13",
  ...
  },
  {
    ...
    answer:
      "Winners are announced after the campaign ends and after a verification process based on views and rankings.",
  },
];
const creatorFaqs = [
  {
    ...
    question: "What is Game of Creators?",
    answer:
      "Game of Creators is the easiest way for creators to get paid for making content for brands—without the hassle of pitching or contracts. Simply join the campaigns of your choice, compete for cash prizes, and get paid based on your performance and views. Followers are no longer a limitation to earn from brand deals—Game of Creators is democratizing brand deals for creators like you.",
  },
  {
    id: "faq-2",
    question: "How do I make money on Game of Creators?",
    answer:
      "Participate in campaigns by posting content on your social media. Compete for organic views, and the top performers will win cash prizes.<br><br><strong>Leaderboard campaigns:</strong> Your ranking matters based on your views.<br><br><strong>CPM campaigns:</strong> Your views determine your earnings, regardless of your rank.<br><br><strong>Milestone campaigns:</strong> You earn fixed payouts when your content reaches view targets set by the brand (first-come, first-served within any per-tier limits).<br><br><strong>Dual rewards campaigns:</strong> You can earn from both CPM performance and milestone payouts within the same campaign.",
  },
  {
    id: "faq-3",
    question: "Do you have paid opportunities for my specific niche?",
    answer:
      "Yes! Game of Creators offers a wide range of campaigns across various niches, including health & fitness, fashion, gaming, finance, and more. Whatever your niche, there's an opportunity for you to participate!",
  },
  {
    id: "faq-4",
    question: "How much money can I make?",
    answer:
      "Earnings vary by opportunity. Some creators make hundreds to thousands of dollars per campaign or deal. The more you create, the more you can earn—there's no limit to how much you can make!",
  },
  {
    id: "faq-5",
  ...
  },
  {
    ...
    answer:
      "Simply register as a creator, browse the available opportunities, and participate in the campaign that resonates with you. If you win, you get paid based on your performance!",
  },
  {
    id: "faq-8",
    question: "Can I participate in multiple campaigns at once?",
    answer:
      "Yes, you can participate in as many campaigns as you like. Each campaign will have its own set of rules and guidelines, so make sure to review them before submitting your content.",
  },
  {
    id: "faq-9",
    question: "What types of content can I submit?",
    answer:
      "The type of content you submit depends on the campaign you're participating in. Brands provide a brief and guidelines for each campaign, which will specify the type of content required. Be sure to follow those instructions to ensure your submission is eligible.",
  },
  {
    id: "faq-10",
    question: "What happens if my content is rejected?",
    answer:
      "If your content is rejected, you will not be eligible for payment. Rejection happens only when you miss campaign rules or miss community guidelines.",
  },
  {
    id: "faq-11",
    question: "Do I need any special equipment to participate?",
    answer:
      "No special equipment is required to participate, but high-quality content tends to perform better. Ensure your videos are clear, engaging, and aligned with the campaign brief.",
  },
  {
    id: "faq-12",
    question: "How do I know if I've won?",
    answer:
      "After the campaign ends, winners will be announced based on their views and performance. You can track your progress through the leaderboard, and if you're a winner, you will receive your payout according to the campaign's structure.",
  },
  {
    id: "faq-13",
    question: "What if I miss the campaign submission deadline?",
    answer:
      "Late submissions are not accepted. Ensure you submit your content within the campaign's live period and submit your link to the campaign page within two hours of posting on YouTube or Instagram.",
  },
  {
    id: "faq-14",
    question: "How are views counted for CPM campaigns?",
    answer:
      "In CPM-based campaigns, views are tracked directly from your organic YouTube or Instagram posts. You earn money based on how many views your content receives and based on min max views criteria, regardless of ranking.",
  },
  {
    id: "faq-15",
    question: "Who owns the content I create if I win?",
    answer:
      "If you win a campaign, both you, the creator, and the brand will have shared ownership of the content. You can use the content for your portfolio and social media (non-commercial use), while the brand can use it for marketing, advertising, and promotions.<br><br>This shared ownership model allows you to keep your work in your portfolio, while also allowing the brand to use the content for their commercial purposes.",
  },
  {
    id: "faq-16",
...
const brandFaqs = [
  {
    id: "faq-brand-1",
    question: "What are campaigns? And How does it work?",
    answer:
      "There are <strong>two types of campaigns</strong> on Game of Creators: <strong>Leaderboard</strong> and <strong>CPM-based campaigns</strong>. These campaigns allow brands to crowdsource a large volume of creator content quickly by launching a competitive campaign.<br><br><strong>How it works:</strong><br>• You set a total prize pool, define your brief and rules<br>• Creators submit videos posted organically on their own YouTube or Instagram accounts<br>• At the end of the campaign (typically lasting 3-28 days, set by you), creators with the most views win and split the prize money based on your payout structure<br>• Plus, you own all the winning content, giving you a library of performance-tested videos for paid ads<br><br>It's the fastest way to test multiple hooks, formats, and creators all at once and get viral marketing with hundreds of creators.",
  },
  {
    id: "faq-brand-2",
    question: "How are the campaign payouts/prizes structured?",
    answer:
      "You have <strong>full control</strong> over how the prize pool is distributed among winners. Prizes are awarded based on organic views, and you can structure payouts to align with your campaign goals.<br><br><strong>Example:</strong> On a $1,000 campaign, you could have 10 winners at $100 each, or 40 winners with this prize distribution:<br><br>• <strong>1st Place:</strong> $300 (A strong, attractive top prize)<br>• <strong>2nd Place:</strong> $150<br>• <strong>3rd Place:</strong> $75<br>• <strong>4th-10th Place</strong> (7 winners): $25 each ($175 total)<br>• <strong>11th-40th Place</strong> (30 winners): $10 each ($300 total)<br><br>The prize pool and distribution are set before your campaign goes live, ensuring clarity and consistency in payouts.",
  },
  {
    id: "faq-brand-3",
    question: "What if my campaign gets no views?",
    answer:
      "Game of Creators operates on a <strong>supply-and-demand model</strong>, ensuring that your campaign won't go unnoticed. With a large network of eager creators, there's always someone ready to compete for your prize pool.<br><br>The prize pool creates an incentive for submissions, which generate views as creators post organically to their audiences. If engagement is lower than expected, we are here to help refine your brief or strategy to maximize participation and results.",
  },
  {
    id: "faq-brand-4",
    question: "How much should I run a campaign for?",
    answer:
      "The ideal budget depends on your campaign goals:<br><br><strong>Optimizing for Paid Ads:</strong> Allocate more winners with smaller prizes for a diverse range of content.<br><br><strong>Maximizing Organic Reach:</strong> Offer fewer but larger payouts to attract top-tier creators for viral, organic reach.<br><br>We recommend starting with at least <strong>$1,000</strong>, but campaigns can begin with as little as <strong>$50</strong>. There is no upper limit.",
  },
  {
    id: "faq-brand-5",
    question: "How do I track conversions?",
    answer:
      "To track conversions effectively, Game of Creators tracks views and engagement on the organic content posted by influencers:<br><br><strong>View and Engagement Metrics:</strong> After the campaign launches, creators post content on their Instagram or YouTube accounts. You can track the views, likes, shares, and other engagement metrics to evaluate each post's performance.<br><br><strong>Custom Call-to-Actions (CTAs):</strong> You can require creators to include a CTA in their content, such as visiting your website or downloading your app, making it easier to connect content performance with measurable outcomes.",
  },
  {
    id: "faq-brand-6",
  ...
  },
  {
    ...
    answer:
      "Game of Creators handles all creator payments seamlessly for you. Once the campaign ends and winners are determined based on organic views, we distribute the prize money directly to the winning creators' wallets.<br><br>From there, they can request a withdrawal at any time through their preferred payment method—<strong>Crypto, Bank Transfer, or UPI</strong>. The only condition is that the payout must be at least <strong>$5</strong>.<br><br>This ensures a smooth process, so you don't have to worry about managing individual payments or logistics.",
  },
];
...
//     answer:
//       "You control how the prize pool is split. For example: 3 winners: $500 / $300 / $200, or 5 winners: $400 / $250 / $150 / $100 / $100. You define this upfront in your campaign brief, and creators compete to win based on real engagement.",
//   },
//   {
//     question: "What if my campaign gets no views?",
//     answer:
...
//     answer:
//       "Yes, once a campaign ends and winners are announced, you get full rights to download and repurpose all winning content for your brand's marketing use—including ads, social posts, website use, etc. Non-winning content may still be available upon request or with creator permission, depending on your use case.",
//   },
//   {
...
//     answer:
//       "Most campaigns run for 7-14 days, which gives creators enough time to develop quality content while maintaining momentum and excitement. However, you have flexibility to set shorter or longer timeframes depending on your specific goals and campaign urgency.",
//   },
//   {
//     question: "Can I run multiple campaigns simultaneously?",
//     answer:
//       "Yes! Depending on your subscription plan, you can run multiple campaigns at the same time. This is perfect for testing different content approaches, targeting various audience segments, or launching campaigns across multiple products simultaneously.",
//   },
// ];
