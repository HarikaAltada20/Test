                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <DialogTitle className="text-xl font-semibold">
                                {isLeaderboard ? 'Adjust Creator Points' : 'Adjust Tweet Points'}
                            </DialogTitle>
                            <DialogDescription className="text-sm text-muted-foreground mt-1">
                                {isLeaderboard 
                                    ? `Adjust points for all tweets by ${creatorName || 'this creator'}. This will affect their total leaderboard score.`
                ...
                <div className="space-y-6 py-6 px-1">
                    ...
                    {currentPoints !== undefined && (
                        <div className={cn(
                            ...
                            <div className="text-sm font-medium mb-1">
                                {isLeaderboard ? 'Current Total Points' : 'Current Tweet Points'}
                            </div>
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="relative">
                            <Input
                                id="points-input"
                                type="number"
                                placeholder={isLeaderboard ? "e.g., +50 or -20" : "e.g., +10 or -5"}
                                value={points}
                        ...
                        {points && !isNaN(parseInt(points, 10)) && (
                            <div className={cn(
                                ...
                                {parseInt(points, 10) > 0 ? '+' : ''}{parseInt(points, 10)} points will be {parseInt(points, 10) > 0 ? 'added' : 'subtracted'}
                            </div>
                        )}
                    </div>
                    ...
                    <Alert className={cn(
                        ...
                        <AlertDescription className={cn(
                            ...
                            <span className="font-medium">Note:</span> {isLeaderboard 
