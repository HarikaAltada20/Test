...
DROP POLICY IF EXISTS "Users can view own transactions" ON public.solana_transactions;
DROP POLICY IF EXISTS "Users can view own transactions" ON public.money_transactions;
DROP POLICY IF EXISTS "Users can view own payment requests" ON public.solana_payment_requests;
DROP POLICY IF EXISTS "Users can view own customer record" ON public.customers;
DROP POLICY IF EXISTS "Users can view basic info about other users" ON public.users;
...
DROP POLICY IF EXISTS "Users can update own transactions" ON public.money_transactions;
...
DROP POLICY IF EXISTS "Users can insert their own advertiser profile" ON public.advertiser_profiles;
...
DROP POLICY IF EXISTS "Users can create own transactions" ON public.money_transactions;
DROP POLICY IF EXISTS "Service role full update access" ON public.money_transactions;
DROP POLICY IF EXISTS "Service role full select access" ON public.money_transactions;
DROP POLICY IF EXISTS "Service role full insert access" ON public.money_transactions;
DROP POLICY IF EXISTS "Service role can view all subscriptions" ON public.subscriptions;
DROP POLICY IF EXISTS "Service role can update transactions" ON public.solana_transactions;
DROP POLICY IF EXISTS "Service role can update subscriptions" ON public.subscriptions;
DROP POLICY IF EXISTS "Service role can update payment requests" ON public.solana_payment_requests;
DROP POLICY IF EXISTS "Service role can manage all transactions" ON public.coin_transactions;
DROP POLICY IF EXISTS "Service role can manage all customer records" ON public.customers;
DROP POLICY IF EXISTS "Service role can insert transactions" ON public.solana_transactions;
DROP POLICY IF EXISTS "Service role can insert subscriptions" ON public.subscriptions;
DROP POLICY IF EXISTS "Service role can insert payment requests" ON public.solana_payment_requests;
...
DROP POLICY IF EXISTS "Public can view all submissions for leaderboard" ON public.submissions;
DROP POLICY IF EXISTS "Public can view advertiser profiles" ON public.advertiser_profiles;
DROP POLICY IF EXISTS "Creators can update their own profile" ON public.creator_profiles;
DROP POLICY IF EXISTS "Creators can read their own profile" ON public.creator_profiles;
DROP POLICY IF EXISTS "Creators can manage their own submissions" ON public.submissions;
DROP POLICY IF EXISTS "Allow anonymous read access to blog posts" ON public.blog_posts;
DROP POLICY IF EXISTS "Advertisers can view their own profile" ON public.advertiser_profiles;
DROP POLICY IF EXISTS "Advertisers can view submissions for their own contests" ON public.submissions;
DROP POLICY IF EXISTS "Advertisers can update their own profile" ON public.advertiser_profiles;
DROP POLICY IF EXISTS "Advertisers can update submissions for their own contests" ON public.submissions;
DROP POLICY IF EXISTS "Advertisers can read their own profile" ON public.advertiser_profiles;
DROP POLICY IF EXISTS "Advertisers can manage their own contests" ON public.contests;
DROP POLICY IF EXISTS "Admins have full access to all submissions" ON public.submissions;
DROP POLICY IF EXISTS "Admins can view all users" ON public.users;
DROP POLICY IF EXISTS "Admins can manage all payout methods" ON public.payout_methods;
DROP POLICY IF EXISTS "Admins can do everything on contests" ON public.contests;
ALTER TABLE IF EXISTS ONLY public.withdrawal_requests DROP CONSTRAINT IF EXISTS withdrawal_requests_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.withdrawal_requests DROP CONSTRAINT IF EXISTS withdrawal_requests_payout_method_id_fkey;
ALTER TABLE IF EXISTS ONLY public.users DROP CONSTRAINT IF EXISTS users_referred_by_fkey;
ALTER TABLE IF EXISTS ONLY public.twitter_campaign_tweets DROP CONSTRAINT IF EXISTS twitter_campaign_tweets_creator_id_fkey;
ALTER TABLE IF EXISTS ONLY public.twitter_campaign_tweets DROP CONSTRAINT IF EXISTS twitter_campaign_tweets_contest_id_fkey;
ALTER TABLE IF EXISTS ONLY public.twitter_campaign_participants DROP CONSTRAINT IF EXISTS twitter_campaign_participants_creator_id_fkey;
ALTER TABLE IF EXISTS ONLY public.twitter_campaign_participants DROP CONSTRAINT IF EXISTS twitter_campaign_participants_contest_id_fkey;
ALTER TABLE IF EXISTS ONLY public.twitter_campaign_metrics DROP CONSTRAINT IF EXISTS twitter_campaign_metrics_contest_id_fkey;
ALTER TABLE IF EXISTS ONLY public.twitter_campaign_leaderboard DROP CONSTRAINT IF EXISTS twitter_campaign_leaderboard_creator_id_fkey;
ALTER TABLE IF EXISTS ONLY public.twitter_campaign_leaderboard DROP CONSTRAINT IF EXISTS twitter_campaign_leaderboard_contest_id_fkey;
ALTER TABLE IF EXISTS ONLY public.survey_redemptions DROP CONSTRAINT IF EXISTS survey_redemptions_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.subscriptions DROP CONSTRAINT IF EXISTS subscriptions_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.subscriptions DROP CONSTRAINT IF EXISTS subscriptions_price_id_fkey;
ALTER TABLE IF EXISTS ONLY public.submissions DROP CONSTRAINT IF EXISTS submissions_creator_id_fkey;
ALTER TABLE IF EXISTS ONLY public.submissions DROP CONSTRAINT IF EXISTS submissions_contest_id_fkey;
ALTER TABLE IF EXISTS ONLY public.submission_views_credited DROP CONSTRAINT IF EXISTS submission_views_credited_submission_id_fkey;
ALTER TABLE IF EXISTS ONLY public.solana_transactions DROP CONSTRAINT IF EXISTS solana_transactions_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.solana_transactions DROP CONSTRAINT IF EXISTS solana_transactions_payment_request_id_fkey;
ALTER TABLE IF EXISTS ONLY public.solana_payment_requests DROP CONSTRAINT IF EXISTS solana_payment_requests_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.queries DROP CONSTRAINT IF EXISTS queries_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.prices DROP CONSTRAINT IF EXISTS prices_product_id_fkey;
ALTER TABLE IF EXISTS ONLY public.payout_methods DROP CONSTRAINT IF EXISTS payout_methods_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.payout_jobs DROP CONSTRAINT IF EXISTS payout_jobs_submission_id_fkey;
ALTER TABLE IF EXISTS ONLY public.payout_jobs DROP CONSTRAINT IF EXISTS payout_jobs_requested_by_fkey;
ALTER TABLE IF EXISTS ONLY public.money_transactions DROP CONSTRAINT IF EXISTS money_transactions_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.form_submissions DROP CONSTRAINT IF EXISTS form_submissions_email_fkey;
ALTER TABLE IF EXISTS ONLY public.money_transactions DROP CONSTRAINT IF EXISTS fk_withdrawal_request;
ALTER TABLE IF EXISTS ONLY public.email_change_logs DROP CONSTRAINT IF EXISTS email_change_logs_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.customers DROP CONSTRAINT IF EXISTS customers_id_fkey;
ALTER TABLE IF EXISTS ONLY public.creator_profiles DROP CONSTRAINT IF EXISTS creator_profiles_id_fkey;
ALTER TABLE IF EXISTS ONLY public.creator_contest_wins DROP CONSTRAINT IF EXISTS creator_contest_wins_creator_id_fkey;
ALTER TABLE IF EXISTS ONLY public.creator_contest_wins DROP CONSTRAINT IF EXISTS creator_contest_wins_contest_id_fkey;
ALTER TABLE IF EXISTS ONLY public.coupon_redemptions DROP CONSTRAINT IF EXISTS coupon_redemptions_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.contests DROP CONSTRAINT IF EXISTS contests_approved_by_fkey;
ALTER TABLE IF EXISTS ONLY public.contests DROP CONSTRAINT IF EXISTS contests_advertiser_id_fkey;
ALTER TABLE IF EXISTS ONLY public.coin_transactions DROP CONSTRAINT IF EXISTS coin_transactions_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.advertiser_profiles DROP CONSTRAINT IF EXISTS advertiser_profiles_id_fkey;
DROP TRIGGER IF EXISTS withdrawal_requests_updated_at_trigger ON public.withdrawal_requests;
...
DROP TRIGGER IF EXISTS update_solana_transactions_updated_at ON public.solana_transactions;
DROP TRIGGER IF EXISTS update_solana_payment_requests_updated_at ON public.solana_payment_requests;
...
DROP TRIGGER IF EXISTS payout_methods_updated_at_trigger ON public.payout_methods;
...
DROP TRIGGER IF EXISTS on_new_submission_increment_count ON public.submissions;
DROP TRIGGER IF EXISTS on_contests_update ON public.contests;
DROP TRIGGER IF EXISTS increment_participant_tweet_count_trigger ON public.twitter_campaign_tweets;
DROP INDEX IF EXISTS public.ux_reward_submission_cycle;
DROP INDEX IF EXISTS public.ux_reward_per_submission_cycle;
DROP INDEX IF EXISTS public.idx_users_username;
DROP INDEX IF EXISTS public.idx_users_affiliate_earnings_gt0;
DROP INDEX IF EXISTS public.idx_twitter_tweets_updated;
DROP INDEX IF EXISTS public.idx_twitter_tweets_tweet_id;
DROP INDEX IF EXISTS public.idx_twitter_tweets_target;
DROP INDEX IF EXISTS public.idx_twitter_tweets_points;
DROP INDEX IF EXISTS public.idx_twitter_tweets_moderation_status;
DROP INDEX IF EXISTS public.idx_twitter_tweets_eligible;
DROP INDEX IF EXISTS public.idx_twitter_tweets_deleted;
DROP INDEX IF EXISTS public.idx_twitter_tweets_creator;
DROP INDEX IF EXISTS public.idx_twitter_tweets_created_at;
DROP INDEX IF EXISTS public.idx_twitter_tweets_contest;
DROP INDEX IF EXISTS public.idx_twitter_participants_creator;
DROP INDEX IF EXISTS public.idx_twitter_participants_contest;
DROP INDEX IF EXISTS public.idx_twitter_participants_active;
DROP INDEX IF EXISTS public.idx_twitter_leaderboard_refresh;
DROP INDEX IF EXISTS public.idx_twitter_leaderboard_rank;
DROP INDEX IF EXISTS public.idx_twitter_leaderboard_points;
DROP INDEX IF EXISTS public.idx_twitter_leaderboard_paid;
DROP INDEX IF EXISTS public.idx_twitter_leaderboard_moderation_status;
DROP INDEX IF EXISTS public.idx_twitter_leaderboard_contest;
DROP INDEX IF EXISTS public.idx_twitter_campaign_metrics_type;
DROP INDEX IF EXISTS public.idx_twitter_campaign_metrics_target;
DROP INDEX IF EXISTS public.idx_twitter_campaign_metrics_contest;
DROP INDEX IF EXISTS public.idx_subscriptions_user_id;
DROP INDEX IF EXISTS public.idx_subscriptions_status;
DROP INDEX IF EXISTS public.idx_subscriptions_price_id;
DROP INDEX IF EXISTS public.idx_subscriptions_period_end;
DROP INDEX IF EXISTS public.idx_subscriptions_active_users;
DROP INDEX IF EXISTS public.idx_submissions_views_locked;
DROP INDEX IF EXISTS public.idx_submissions_views_created_at;
DROP INDEX IF EXISTS public.idx_submissions_verified_by_contest;
DROP INDEX IF EXISTS public.idx_submissions_status_contest_id;
DROP INDEX IF EXISTS public.idx_submissions_status;
DROP INDEX IF EXISTS public.idx_submissions_paid;
DROP INDEX IF EXISTS public.idx_submissions_metadata_type;
DROP INDEX IF EXISTS public.idx_submissions_metadata_timestamp;
DROP INDEX IF EXISTS public.idx_submissions_creator_id_contest_id;
DROP INDEX IF EXISTS public.idx_submissions_creator_contest_status;
DROP INDEX IF EXISTS public.idx_submissions_creator_contest_created;
DROP INDEX IF EXISTS public.idx_submissions_creator_contest;
DROP INDEX IF EXISTS public.idx_submissions_contest_views;
DROP INDEX IF EXISTS public.idx_submissions_contest_status_views_created;
DROP INDEX IF EXISTS public.idx_submissions_contest_status_views;
DROP INDEX IF EXISTS public.idx_submissions_contest_paid;
DROP INDEX IF EXISTS public.idx_submissions_contest_id_status;
DROP INDEX IF EXISTS public.idx_submissions_contest_id;
DROP INDEX IF EXISTS public.idx_submissions_contest_created_at;
DROP INDEX IF EXISTS public.idx_submissions_contest_created;
DROP INDEX IF EXISTS public.idx_submissions_bonus_paid;
DROP INDEX IF EXISTS public.idx_submissions_bonus_amount;
DROP INDEX IF EXISTS public.idx_submissions_affiliate_paid;
DROP INDEX IF EXISTS public.idx_solana_transactions_verification_status;
DROP INDEX IF EXISTS public.idx_solana_transactions_user_id;
DROP INDEX IF EXISTS public.idx_solana_transactions_status;
DROP INDEX IF EXISTS public.idx_solana_transactions_signature;
DROP INDEX IF EXISTS public.idx_solana_transactions_payment_request_id;
DROP INDEX IF EXISTS public.idx_solana_payment_requests_user_id;
DROP INDEX IF EXISTS public.idx_solana_payment_requests_status;
DROP INDEX IF EXISTS public.idx_solana_payment_requests_reference_id;
DROP INDEX IF EXISTS public.idx_solana_payment_requests_expires_at;
...
DROP INDEX IF EXISTS public.idx_prices_amount_interval;
DROP INDEX IF EXISTS public.idx_prices_active;
DROP INDEX IF EXISTS public.idx_payout_jobs_status_created_at;
DROP INDEX IF EXISTS public.idx_money_tx_user_type;
DROP INDEX IF EXISTS public.idx_money_tx_submission_id;
DROP INDEX IF EXISTS public.idx_money_transactions_webhook_lookup;
DROP INDEX IF EXISTS public.idx_money_transactions_user_status;
DROP INDEX IF EXISTS public.idx_money_transactions_remarks;
DROP INDEX IF EXISTS public.idx_money_transactions_payment_method;
DROP INDEX IF EXISTS public.idx_money_transactions_payment_intent_id;
DROP INDEX IF EXISTS public.idx_money_transactions_metadata;
DROP INDEX IF EXISTS public.idx_money_transactions_created_at;
DROP INDEX IF EXISTS public.idx_customers_stripe_customer_id;
DROP INDEX IF EXISTS public.idx_customers_default_payment_method;
DROP INDEX IF EXISTS public.idx_creator_contest_wins_creator_id;
DROP INDEX IF EXISTS public.idx_creator_contest_wins_contest_id;
DROP INDEX IF EXISTS public.idx_coupon_redemptions_unique;
DROP INDEX IF EXISTS public.idx_contests_twitter_keywords;
DROP INDEX IF EXISTS public.idx_contests_twitter_hashtags;
DROP INDEX IF EXISTS public.idx_contests_twitter_campaign_type;
DROP INDEX IF EXISTS public.idx_contests_twitter_campaign;
DROP INDEX IF EXISTS public.idx_contests_subscription_info_of_user;
DROP INDEX IF EXISTS public.idx_contests_rules_html;
DROP INDEX IF EXISTS public.idx_contests_post_contest_status;
DROP INDEX IF EXISTS public.idx_contests_platform_twitter;
DROP INDEX IF EXISTS public.idx_contests_multiple_submissions;
DROP INDEX IF EXISTS public.idx_contests_moderation_status;
DROP INDEX IF EXISTS public.idx_contests_last_metrics_updated;
DROP INDEX IF EXISTS public.idx_contests_content_type;
DROP INDEX IF EXISTS public.idx_contests_brief_html;
DROP INDEX IF EXISTS public.idx_contests_approved_by;
DROP INDEX IF EXISTS public.idx_contests_active;
DROP INDEX IF EXISTS public.idx_coin_transactions_user_id;
DROP INDEX IF EXISTS public.idx_coin_transactions_type_status;
DROP INDEX IF EXISTS public.idx_coin_transactions_created_at;
DROP INDEX IF EXISTS public.idx_advertiser_profiles_subscription_info;
...
ALTER TABLE IF EXISTS ONLY public.twitter_campaign_tweets DROP CONSTRAINT IF EXISTS twitter_campaign_tweets_pkey;
ALTER TABLE IF EXISTS ONLY public.twitter_campaign_tweets DROP CONSTRAINT IF EXISTS twitter_campaign_tweets_contest_id_tweet_id_key;
ALTER TABLE IF EXISTS ONLY public.twitter_campaign_participants DROP CONSTRAINT IF EXISTS twitter_campaign_participants_pkey;
ALTER TABLE IF EXISTS ONLY public.twitter_campaign_participants DROP CONSTRAINT IF EXISTS twitter_campaign_participants_contest_id_creator_id_key;
ALTER TABLE IF EXISTS ONLY public.twitter_campaign_metrics DROP CONSTRAINT IF EXISTS twitter_campaign_metrics_pkey;
ALTER TABLE IF EXISTS ONLY public.twitter_campaign_leaderboard DROP CONSTRAINT IF EXISTS twitter_campaign_leaderboard_pkey;
ALTER TABLE IF EXISTS ONLY public.twitter_campaign_leaderboard DROP CONSTRAINT IF EXISTS twitter_campaign_leaderboard_contest_id_creator_id_key;
ALTER TABLE IF EXISTS ONLY public.survey_redemptions DROP CONSTRAINT IF EXISTS survey_bonus_redemptions_pkey;
ALTER TABLE IF EXISTS ONLY public.subscriptions DROP CONSTRAINT IF EXISTS subscriptions_pkey;
ALTER TABLE IF EXISTS ONLY public.submissions DROP CONSTRAINT IF EXISTS submissions_pkey;
ALTER TABLE IF EXISTS ONLY public.submission_views_credited DROP CONSTRAINT IF EXISTS submission_views_credited_pkey;
ALTER TABLE IF EXISTS ONLY public.solana_transactions DROP CONSTRAINT IF EXISTS solana_transactions_transaction_signature_key;
ALTER TABLE IF EXISTS ONLY public.solana_transactions DROP CONSTRAINT IF EXISTS solana_transactions_pkey;
ALTER TABLE IF EXISTS ONLY public.solana_payment_requests DROP CONSTRAINT IF EXISTS solana_payment_requests_reference_id_key;
ALTER TABLE IF EXISTS ONLY public.solana_payment_requests DROP CONSTRAINT IF EXISTS solana_payment_requests_pkey;
...
ALTER TABLE IF EXISTS ONLY public.email_change_logs DROP CONSTRAINT IF EXISTS email_change_logs_pkey;
ALTER TABLE IF EXISTS ONLY public.customers DROP CONSTRAINT IF EXISTS customers_stripe_customer_id_key;
ALTER TABLE IF EXISTS ONLY public.customers DROP CONSTRAINT IF EXISTS customers_pkey;
ALTER TABLE IF EXISTS ONLY public.creator_profiles DROP CONSTRAINT IF EXISTS creator_profiles_pkey;
ALTER TABLE IF EXISTS ONLY public.creator_contest_wins DROP CONSTRAINT IF EXISTS creator_contest_wins_pkey;
...
ALTER TABLE IF EXISTS ONLY public.coin_transactions DROP CONSTRAINT IF EXISTS coin_transactions_pkey;
ALTER TABLE IF EXISTS ONLY public.blog_posts DROP CONSTRAINT IF EXISTS blog_posts_pkey;
ALTER TABLE IF EXISTS ONLY public.advertiser_profiles DROP CONSTRAINT IF EXISTS advertiser_profiles_pkey;
DROP TABLE IF EXISTS public.users;
DROP TABLE IF EXISTS public.twitter_campaign_tweets;
DROP TABLE IF EXISTS public.twitter_campaign_participants;
DROP TABLE IF EXISTS public.twitter_campaign_metrics;
DROP TABLE IF EXISTS public.twitter_campaign_leaderboard;
DROP TABLE IF EXISTS public.survey_redemptions;
DROP TABLE IF EXISTS public.subscriptions;
DROP TABLE IF EXISTS public.submissions;
DROP TABLE IF EXISTS public.submission_views_credited;
DROP TABLE IF EXISTS public.solana_transactions;
DROP TABLE IF EXISTS public.solana_payment_requests;
...
DROP TABLE IF EXISTS public.email_change_logs;
DROP TABLE IF EXISTS public.customers;
DROP TABLE IF EXISTS public.creator_profiles;
DROP TABLE IF EXISTS public.creator_contest_wins;
...
DROP TABLE IF EXISTS public.advertiser_profiles;
DROP FUNCTION IF EXISTS public.update_updated_at_column();
DROP FUNCTION IF EXISTS public.update_twitter_tweet_updated_at();
DROP FUNCTION IF EXISTS public.update_transaction_status_by_payment_intent_fast(p_payment_intent_id text, p_new_status text, p_new_description text, p_remarks text);
DROP FUNCTION IF EXISTS public.update_transaction_status_by_payment_intent_fast(p_payment_intent_id text, p_new_status text, p_new_description text);
DROP FUNCTION IF EXISTS public.update_transaction_status_by_payment_intent(payment_intent_id text, new_status text, new_description text);
DROP FUNCTION IF EXISTS public.update_subscription(stripe_subscription_id text, new_status text, new_price_id text, new_period_start timestamp with time zone, new_period_end timestamp with time zone, new_quantity integer, cancel_at_period_end_param boolean, cancel_at_param timestamp with time zone, canceled_at_param timestamp with time zone, ended_at_param timestamp with time zone, trial_start_param timestamp with time zone, trial_end_param timestamp with time zone, stripe_metadata_param jsonb, internal_notes_param text);
DROP FUNCTION IF EXISTS public.update_solana_updated_at_column();
DROP FUNCTION IF EXISTS public.update_creator_wins_on_status_change();
DROP FUNCTION IF EXISTS public.update_creator_contests_participated_on_insert();
DROP FUNCTION IF EXISTS public.rls_auto_enable();
DROP FUNCTION IF EXISTS public.process_referral_signup(p_referred_id uuid, p_ref_code text, p_referrer_id uuid, p_referred_user_type text, p_referred_user_name text);
DROP FUNCTION IF EXISTS public.lock_verified_submission_views(p_contest_id uuid);
DROP FUNCTION IF EXISTS public.increment_participant_tweet_count();
DROP FUNCTION IF EXISTS public.increment_creator_submissions_made();
DROP FUNCTION IF EXISTS public.increment_contest_submission_count();
DROP FUNCTION IF EXISTS public.increment_affilate_earnings(p_user_id uuid, p_amount integer);
DROP FUNCTION IF EXISTS public.handle_updated_at();
DROP FUNCTION IF EXISTS public.grant_welcome_bonus(new_user_id uuid, p_user_type text, p_user_name text);
DROP FUNCTION IF EXISTS public.grant_referral_cash_bonus(p_user_id uuid, p_ref_code text);
DROP FUNCTION IF EXISTS public.get_user_role();
DROP FUNCTION IF EXISTS public.get_twitter_campaign_type(contest_id uuid);
DROP FUNCTION IF EXISTS public.get_total_transactions_count();
DROP FUNCTION IF EXISTS public.get_pending_transaction_by_payment_intent_fast(p_payment_intent_id text);
DROP FUNCTION IF EXISTS public.get_pending_transaction_by_payment_intent(payment_intent_id text);
DROP FUNCTION IF EXISTS public.expire_old_payment_requests();
DROP FUNCTION IF EXISTS public.credit_creator_cash_atomic(p_user_id uuid, p_amount_cents integer, p_description text, p_remarks text);
DROP FUNCTION IF EXISTS public.credit_advertiser_cash_atomic(p_user_id uuid, p_amount_cents integer, p_description text, p_remarks text);
DROP FUNCTION IF EXISTS public.create_withdrawal_request(p_user_id uuid, p_payout_method_id uuid, p_amount integer, p_currency text, p_amount_type text, p_user_notes text, p_redeemed_item_description jsonb);
DROP FUNCTION IF EXISTS public.create_subscription(stripe_subscription_id text, user_uuid uuid, stripe_price_id text, subscription_status text, period_start timestamp with time zone, period_end timestamp with time zone, subscription_quantity integer, cancel_at_period_end_param boolean, cancel_at_param timestamp with time zone, trial_start_param timestamp with time zone, trial_end_param timestamp with time zone, stripe_metadata_param jsonb, internal_notes_param text);
DROP FUNCTION IF EXISTS public.create_advertiser_withdrawal_request(p_user_id uuid, p_payout_method_id uuid, p_amount integer, p_currency text, p_amount_type text, p_user_notes text, p_redeemed_item_description jsonb);
DROP TABLE IF EXISTS public.withdrawal_requests;
DROP FUNCTION IF EXISTS public.cancel_withdrawal_request_by_user(p_request_id uuid, p_user_id uuid);
DROP FUNCTION IF EXISTS public.cancel_subscription(stripe_subscription_id text, canceled_at_param timestamp with time zone, ended_at_param timestamp with time zone, cancel_at_param timestamp with time zone, cancellation_reason text);
DROP FUNCTION IF EXISTS public.cancel_advertiser_withdrawal_request_by_user(p_request_id uuid, p_user_id uuid);
DROP FUNCTION IF EXISTS public.batch_update_transaction_statuses(p_payment_intent_ids text[], p_new_status text);
DROP FUNCTION IF EXISTS public.archive_old_transactions(p_days_old integer);
DROP TYPE IF EXISTS public.subscription_status;
DROP TYPE IF EXISTS public.submission_status_enum;
DROP TYPE IF EXISTS public.pricing_type;
DROP TYPE IF EXISTS public.pricing_interval;
DROP TYPE IF EXISTS public.post_contest_status_enum;
DROP TYPE IF EXISTS public.contest_type_enum;
DROP TYPE IF EXISTS public.contest_moderation_status_enum;
...
--
-- Name: blog_post_status_enum; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: TYPE blog_post_status_enum; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: get_twitter_campaign_type(uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_twitter_campaign_type(contest_id uuid) RETURNS text
    LANGUAGE sql STABLE
    AS $$
...
--
-- Name: increment_participant_tweet_count(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.increment_participant_tweet_count() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- Name: update_twitter_tweet_updated_at(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.update_twitter_tweet_updated_at() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
CREATE TABLE public.blog_posts (
    ...
    status public.blog_post_status_enum DEFAULT 'draft'::public.blog_post_status_enum,
...
CREATE TABLE public.contests (
    ...
    interests jsonb,
    region jsonb,
    contest_format text DEFAULT 'video'::text,
    CONSTRAINT contests_content_type_check CHECK ((content_type = ANY (ARRAY['ugc'::text, 'clipping'::text, 'other'::text, 'raid'::text, 'awareness'::text])))
);
...
--
-- Name: COLUMN contests.contest_format; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN creator_profiles.tiktok_account; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: twitter_campaign_leaderboard; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.twitter_campaign_leaderboard (
    ...
    next_refresh_available_at timestamp with time zone DEFAULT (now() + '01:00:00'::interval) NOT NULL,
    refresh_count integer DEFAULT 0,
    moderation_status text DEFAULT 'pending'::text,
    rejection_reason text,
    manual_points_adjustment integer DEFAULT 0,
    manual_points_reason text,
    paid boolean DEFAULT false,
    paid_at timestamp with time zone,
    earnings integer DEFAULT 0,
    paid_rank integer,
    CONSTRAINT twitter_campaign_leaderboard_moderation_status_check CHECK ((moderation_status = ANY (ARRAY['pending'::text, 'verified'::text, 'rejected'::text, 'paid'::text])))
);


--
-- Name: TABLE twitter_campaign_leaderboard; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN twitter_campaign_leaderboard.moderation_status; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.twitter_campaign_leaderboard.moderation_status IS 'Creator-level moderation status: pending (awaiting review), verified (approved but not paid), rejected (all tweets rejected), paid (approved and payment processed)';


--
-- Name: COLUMN twitter_campaign_leaderboard.rejection_reason; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN twitter_campaign_leaderboard.manual_points_adjustment; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN twitter_campaign_leaderboard.manual_points_reason; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN twitter_campaign_leaderboard.paid; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN twitter_campaign_leaderboard.paid_at; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN twitter_campaign_leaderboard.earnings; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN twitter_campaign_leaderboard.paid_rank; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: twitter_campaign_metrics; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.twitter_campaign_metrics (
    contest_id uuid NOT NULL,
    campaign_type text NOT NULL,
    total_filtered_tweets integer DEFAULT 0,
    ...
    target_quote_reposts integer,
    target_current_likes integer,
    target_current_comments integer,
    target_current_retweets integer,
    target_current_quote_reposts integer,
    target_current_views integer,
    targets_reached boolean,
    last_updated_at timestamp with time zone DEFAULT now() NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT twitter_campaign_metrics_campaign_type_check CHECK ((campaign_type = ANY (ARRAY['raid'::text, 'awareness'::text])))
);


--
-- Name: TABLE twitter_campaign_metrics; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: twitter_campaign_participants; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.twitter_campaign_participants (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    contest_id uuid NOT NULL,
    creator_id uuid NOT NULL,
    ...
    last_tweet_fetched_at timestamp with time zone,
...
--
-- Name: TABLE twitter_campaign_participants; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: twitter_campaign_tweets; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.twitter_campaign_tweets (
    ...
    tweet_media_urls jsonb DEFAULT '[]'::jsonb,
    tweet_type text DEFAULT 'tweet'::text,
    is_eligible boolean DEFAULT false,
    eligibility_reason text,
    filter_status text DEFAULT 'pending'::text,
    ...
    manual_points_reason text,
    target_tweet_id text,
    CONSTRAINT twitter_campaign_tweets_filter_status_check CHECK ((filter_status = ANY (ARRAY['pending'::text, 'eligible'::text, 'filtered_out'::text, 'deleted'::text]))),
    CONSTRAINT twitter_campaign_tweets_moderation_status_check CHECK ((moderation_status = ANY (ARRAY['pending'::text, 'verified'::text, 'rejected'::text, 'paid'::text]))),
    CONSTRAINT twitter_campaign_tweets_tweet_type_check CHECK ((tweet_type = ANY (ARRAY['tweet'::text, 'quote'::text, 'retweet'::text, 'reply'::text])))
);


--
-- Name: TABLE twitter_campaign_tweets; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN twitter_campaign_tweets.moderation_status; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.twitter_campaign_tweets.moderation_status IS 'Moderation status: pending (awaiting review), verified (approved but not paid), rejected (not approved), paid (approved and payment processed)';


--
-- Name: COLUMN twitter_campaign_tweets.manual_points_adjustment; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN twitter_campaign_tweets.manual_points_reason; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN twitter_campaign_tweets.target_tweet_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN users.geo_data; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: twitter_campaign_leaderboard twitter_campaign_leaderboard_contest_id_creator_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.twitter_campaign_leaderboard
    ADD CONSTRAINT twitter_campaign_leaderboard_contest_id_creator_id_key UNIQUE (contest_id, creator_id);


--
-- Name: twitter_campaign_leaderboard twitter_campaign_leaderboard_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.twitter_campaign_leaderboard
    ADD CONSTRAINT twitter_campaign_leaderboard_pkey PRIMARY KEY (id);


--
-- Name: twitter_campaign_metrics twitter_campaign_metrics_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.twitter_campaign_metrics
    ADD CONSTRAINT twitter_campaign_metrics_pkey PRIMARY KEY (contest_id);


--
-- Name: twitter_campaign_participants twitter_campaign_participants_contest_id_creator_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.twitter_campaign_participants
    ADD CONSTRAINT twitter_campaign_participants_contest_id_creator_id_key UNIQUE (contest_id, creator_id);


--
-- Name: twitter_campaign_participants twitter_campaign_participants_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.twitter_campaign_participants
    ADD CONSTRAINT twitter_campaign_participants_pkey PRIMARY KEY (id);


--
-- Name: twitter_campaign_tweets twitter_campaign_tweets_contest_id_tweet_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.twitter_campaign_tweets
    ADD CONSTRAINT twitter_campaign_tweets_contest_id_tweet_id_key UNIQUE (contest_id, tweet_id);


--
-- Name: twitter_campaign_tweets twitter_campaign_tweets_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.twitter_campaign_tweets
    ADD CONSTRAINT twitter_campaign_tweets_pkey PRIMARY KEY (id);
...
--
-- Name: idx_contests_platform_twitter; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_contests_platform_twitter ON public.contests USING btree (platform) WHERE ((platform = 'twitter'::text) AND ((contest_based_details -> 'twitter_campaign'::text) IS NOT NULL));
...
--
-- Name: idx_contests_twitter_campaign; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_contests_twitter_campaign ON public.contests USING gin (((contest_based_details -> 'twitter_campaign'::text)));


--
-- Name: idx_contests_twitter_campaign_type; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_contests_twitter_campaign_type ON public.contests USING btree ((((contest_based_details -> 'twitter_campaign'::text) ->> 'campaign_type'::text))) WHERE ((contest_based_details -> 'twitter_campaign'::text) IS NOT NULL);


--
-- Name: idx_contests_twitter_hashtags; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_contests_twitter_hashtags ON public.contests USING gin (((((contest_based_details -> 'twitter_campaign'::text) -> 'keyword_config'::text) -> 'hashtags'::text)));


--
-- Name: idx_contests_twitter_keywords; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_contests_twitter_keywords ON public.contests USING gin (((((contest_based_details -> 'twitter_campaign'::text) -> 'keyword_config'::text) -> 'keywords'::text)));
...
--
-- Name: idx_twitter_campaign_metrics_contest; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_twitter_campaign_metrics_contest ON public.twitter_campaign_metrics USING btree (contest_id);


--
-- Name: idx_twitter_campaign_metrics_target; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_twitter_campaign_metrics_target ON public.twitter_campaign_metrics USING btree (contest_id, target_tweet_id) WHERE (target_tweet_id IS NOT NULL);


--
-- Name: idx_twitter_campaign_metrics_type; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_twitter_campaign_metrics_type ON public.twitter_campaign_metrics USING btree (campaign_type);


--
-- Name: idx_twitter_leaderboard_contest; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_twitter_leaderboard_contest ON public.twitter_campaign_leaderboard USING btree (contest_id);


--
-- Name: idx_twitter_leaderboard_moderation_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_twitter_leaderboard_moderation_status ON public.twitter_campaign_leaderboard USING btree (contest_id, moderation_status) WHERE (moderation_status IS NOT NULL);


--
-- Name: idx_twitter_leaderboard_paid; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_twitter_leaderboard_paid ON public.twitter_campaign_leaderboard USING btree (contest_id, paid) WHERE (paid = true);


--
-- Name: idx_twitter_leaderboard_points; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_twitter_leaderboard_points ON public.twitter_campaign_leaderboard USING btree (contest_id, total_points DESC);


--
-- Name: idx_twitter_leaderboard_rank; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_twitter_leaderboard_rank ON public.twitter_campaign_leaderboard USING btree (contest_id, current_rank);


--
-- Name: idx_twitter_leaderboard_refresh; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_twitter_leaderboard_refresh ON public.twitter_campaign_leaderboard USING btree (contest_id, next_refresh_available_at);


--
-- Name: idx_twitter_participants_active; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_twitter_participants_active ON public.twitter_campaign_participants USING btree (contest_id, is_active) WHERE (is_active = true);


--
-- Name: idx_twitter_participants_contest; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_twitter_participants_contest ON public.twitter_campaign_participants USING btree (contest_id);


--
-- Name: idx_twitter_participants_creator; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_twitter_participants_creator ON public.twitter_campaign_participants USING btree (creator_id);


--
-- Name: idx_twitter_tweets_contest; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_twitter_tweets_contest ON public.twitter_campaign_tweets USING btree (contest_id);


--
-- Name: idx_twitter_tweets_created_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_twitter_tweets_created_at ON public.twitter_campaign_tweets USING btree (tweet_created_at DESC);


--
-- Name: idx_twitter_tweets_creator; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_twitter_tweets_creator ON public.twitter_campaign_tweets USING btree (creator_id);


--
-- Name: idx_twitter_tweets_deleted; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_twitter_tweets_deleted ON public.twitter_campaign_tweets USING btree (contest_id, is_deleted) WHERE (is_deleted = false);


--
-- Name: idx_twitter_tweets_eligible; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_twitter_tweets_eligible ON public.twitter_campaign_tweets USING btree (contest_id, is_eligible, filter_status) WHERE ((is_eligible = true) AND (filter_status = 'eligible'::text));


--
-- Name: idx_twitter_tweets_moderation_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_twitter_tweets_moderation_status ON public.twitter_campaign_tweets USING btree (contest_id, moderation_status) WHERE (moderation_status IS NOT NULL);


--
-- Name: idx_twitter_tweets_points; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_twitter_tweets_points ON public.twitter_campaign_tweets USING btree (contest_id, creator_id, points DESC);


--
-- Name: idx_twitter_tweets_target; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_twitter_tweets_target ON public.twitter_campaign_tweets USING btree (contest_id, target_tweet_id) WHERE (target_tweet_id IS NOT NULL);


--
-- Name: idx_twitter_tweets_tweet_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_twitter_tweets_tweet_id ON public.twitter_campaign_tweets USING btree (tweet_id);


--
-- Name: idx_twitter_tweets_updated; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_twitter_tweets_updated ON public.twitter_campaign_tweets USING btree (contest_id, last_updated_at DESC);
...
--
-- Name: twitter_campaign_tweets increment_participant_tweet_count_trigger; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER increment_participant_tweet_count_trigger AFTER INSERT ON public.twitter_campaign_tweets FOR EACH ROW EXECUTE FUNCTION public.increment_participant_tweet_count();
...
--
-- Name: twitter_campaign_tweets update_twitter_tweets_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_twitter_tweets_updated_at BEFORE UPDATE ON public.twitter_campaign_tweets FOR EACH ROW EXECUTE FUNCTION public.update_twitter_tweet_updated_at();
...
--
-- Name: twitter_campaign_leaderboard twitter_campaign_leaderboard_contest_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.twitter_campaign_leaderboard
    ADD CONSTRAINT twitter_campaign_leaderboard_contest_id_fkey FOREIGN KEY (contest_id) REFERENCES public.contests(id) ON DELETE CASCADE;


--
-- Name: twitter_campaign_leaderboard twitter_campaign_leaderboard_creator_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.twitter_campaign_leaderboard
    ADD CONSTRAINT twitter_campaign_leaderboard_creator_id_fkey FOREIGN KEY (creator_id) REFERENCES public.users(id) ON DELETE CASCADE;


--
-- Name: twitter_campaign_metrics twitter_campaign_metrics_contest_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.twitter_campaign_metrics
    ADD CONSTRAINT twitter_campaign_metrics_contest_id_fkey FOREIGN KEY (contest_id) REFERENCES public.contests(id) ON DELETE CASCADE;


--
-- Name: twitter_campaign_participants twitter_campaign_participants_contest_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.twitter_campaign_participants
    ADD CONSTRAINT twitter_campaign_participants_contest_id_fkey FOREIGN KEY (contest_id) REFERENCES public.contests(id) ON DELETE CASCADE;


--
-- Name: twitter_campaign_participants twitter_campaign_participants_creator_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.twitter_campaign_participants
    ADD CONSTRAINT twitter_campaign_participants_creator_id_fkey FOREIGN KEY (creator_id) REFERENCES public.users(id) ON DELETE CASCADE;


--
-- Name: twitter_campaign_tweets twitter_campaign_tweets_contest_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.twitter_campaign_tweets
    ADD CONSTRAINT twitter_campaign_tweets_contest_id_fkey FOREIGN KEY (contest_id) REFERENCES public.contests(id) ON DELETE CASCADE;


--
-- Name: twitter_campaign_tweets twitter_campaign_tweets_creator_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.twitter_campaign_tweets
    ADD CONSTRAINT twitter_campaign_tweets_creator_id_fkey FOREIGN KEY (creator_id) REFERENCES public.users(id) ON DELETE CASCADE;
...
--
-- Name: blog_posts Allow anonymous read access to blog posts; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Allow anonymous read access to blog posts" ON public.blog_posts FOR SELECT USING (true);
